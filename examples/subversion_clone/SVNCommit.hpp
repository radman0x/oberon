...
#ifndef SVNCLONE_SVNCOMMIT_HPP
#define SVNCLONE_SVNCOMMIT_HPP
...
{
//**********************************************************************************************************************
  class SVNCommit : public SVNSubcommand
  {
  public: // static interface
    static const std::string NAME;

  public: // interface
    SVNCommit(const oberon::OptionCollection& sharedSVNOptions,
    ...
    //@{
      ...
      /** commit can accept either positional paths or the --targets option, so we need to check for this meta dependency */
