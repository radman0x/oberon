...
//**********************************************************************************************************************
  ...
  public: // interface
    Remove() :
      oberon::Subcommand("remove", "remove a character from the provided string")
    {
      /** **/
    }
    ...
    boost::program_options::options_description uniqueOptions(bool includeHidden, bool enableRestrictions) const
    {
      ...
      returnOptions.add_options()
          ("removeChar", oberon::Subcommand::getOptionValue<char>(enableRestrictions), "Single character to remove from the string")
          ("input", oberon::Subcommand::getOptionValue<std::string>(enableRestrictions), "Input string to perform operations on")
